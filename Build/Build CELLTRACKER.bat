...
%WINDIR%\Microsoft.NET\Framework\v4.0.30319\msbuild.exe /fl /flp:LogFile="..\Build\%builddir%\ShutDownServer.log";Append;errorsonly /nologo /p:WarningLevel=0;Optimize=True;OutputPath="..\Build\%builddir%\SHUTDOWSERVER";Platform=AnyCPU;TargetFrameworkVersion=v4.5 /clp:Verbosity=m; /t:Rebuild /p:Configuration=Release ..\ShutDownServer\ShutDownServer.csproj
pause